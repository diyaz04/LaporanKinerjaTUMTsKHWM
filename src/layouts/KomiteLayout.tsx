...
export default function KomiteLayout() {
  ...
  const navItems = [
    { name: 'Laporan Karyawan', path: '/komite', icon: FileText },
  ]
      ...
      >
        <div className="p-4 border-b flex justify-between items-center bg-white">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-green-500 to-emerald-600 bg-clip-text text-transparent leading-tight">Komite MTsU</h1>
        ...
        <header className="bg-white border-b px-4 py-3 flex items-center justify-between md:hidden sticky top-0 z-10 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-lg font-bold leading-none">Komite MTsU</h1>
